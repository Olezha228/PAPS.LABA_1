...
- Параметры запроса:
  ...
  - Этот метод возвращает список скважи отсортированных по полю заданномк в параметре sortField.
...
- Этот метод возвращает отфильтрованный список скважин по глубине с промежутком значений по глубине от minDepth до maxDepth.
...
- Этот метод создает новую скважину с именем name.
...
- Этот метод обновляет информацию о скважине с идентификатором равным id и задает значение для имени скважины - name.
...
- Параметры запроса:
  1. id - идентификатор скважины
- Этот метод удаляет скважину с идентификатором id и при успешном удалении выдает "Well deleted successfully."
- 
